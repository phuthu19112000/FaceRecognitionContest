...
def upload_binary():
    # 1: Phan tich du lieu tu web
    # 2: tao encode(vector) tu anh mat
    # 3: luu thong tin encode va thong tin staff len database
    # function < 50 dong
    # moi function chi lam mot viec
    """
    ...
    try:
        ...
        # Make encode
        #input_image = cv2.imread(img_file_path)
        ...
        # errcode, img_encode = facenet.make_encode(input_image)
        if errcode is 0:
