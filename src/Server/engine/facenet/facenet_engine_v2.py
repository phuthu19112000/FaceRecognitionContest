...
class FacenetEngine(object):
    ...
    def recognize(self, image_path, image_data=None):
        ...
        # Start code here
        # result = self.__detector.detect_faces(image_data)
        # bounding_box = result[0]["box"]
        # image_data = image_data[bounding_box[1]-70:bounding_box[1]-70+bounding_box[3]+100,
        #                                     bounding_box[0]-70:bounding_box[0]+bounding_box[2]+50]
        # image_data = cv2.resize(image_data,(160,160))
        # end code here
